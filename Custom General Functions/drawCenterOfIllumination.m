function circ = drawCenterOfIllumination(image, minVal, maxVal)
	...
	text(.05, .95, {'X, Y Center (pixels)', ['[', num2str(circ.XYcenter(1), '%.1f'), ', ', num2str(circ.XYcenter(2), '%.1f'), ']'], ...
		'Radius (pixels)', num2str(circ.Radius, '%.2f')}, 'Color', 'red', 'Units', 'normalized', 'VerticalAlignment', ...
